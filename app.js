...
.pauseFor(1800)
.changeDelay(20)
.typeString('Je suis Lucas')
.pauseFor(300)
// Webdesigner
.typeString('<strong>, Webdesigner et Intégrateur</strong> !')
.pauseFor(1000)
.deleteChars(28)
.typeString('<span style="color: #27ae60;"> Photoshop</span> !')
.pauseFor(1000)
.deleteChars(11)
.typeString('<span style="color: #EA39ff;"> Illustrator</span> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: midnightblue;"> Indesign</span> !')
.pauseFor(1000)
.deleteChars(10)
.typeString('<span style="color: midnightblue;"> Adobe XD et Figma</span> !')
.pauseFor(1000)
.deleteChars(19)
.typeString('<span style="color: #EA39ff;"> After Effects</span> !')
.pauseFor(1000)
.deleteChars(15)
.typeString('<span style="color: midnightblue;"> Premiere Pro</span> !')
.pauseFor(1000)
.deleteChars(14)
.typeString('<span style="color: midnightblue;"> Animate</span> !')
.pauseFor(1000)
.deleteChars(9)
.typeString('<span style="color: #27ae60;"> CSS et SASS</span> !')
.pauseFor(1000)
.deleteChars(13)
